...
public class LibreCambista implements ILibreCambista {
    ...
    public void visitarPais(Bolivia bolivia, EleccionDeCambio eleccionDeCambio) {
    ...
    @Override
    public void visitarPais(Brasil brasil, EleccionDeCambio eleccionDeCambio) {
    ...
    @Override
    public void visitarPais(Argentina argentina, EleccionDeCambio eleccionDeCambio) {
    ...
    @Override
    public void visitarPais(Italia italia, EleccionDeCambio eleccionDeCambio) {
